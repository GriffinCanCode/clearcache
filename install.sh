...
if [ $? -eq 0 ]; then
    ...
    echo "  clearcache                      # Clean current directory (safe caches only)"
    echo "  clearcache /path/to/dir         # Clean specific directory (safe caches only)"
    echo "  clearcache --include-libraries  # Include dependencies that require reinstallation"
